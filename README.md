...
| 工具函数prompt模板 | 提示词工程中每个函数的prompt模板，用于生成函数调用的提示词，一般不需要修改                                                                                                                                                                                                     |
...
| web_search            | 搜索引擎搜索                   |     需要配置联网搜索后端                                 |
| web_read              | 阅读网页                     |     需要配置网页读取后端                                 |
...
| meme_list             | 获取表情包列表                   |                                      |
| get_meme_info         | 获取指定表情包的信息                   |                                      |
| meme_generator        | 生成表情包                   |                                      |
